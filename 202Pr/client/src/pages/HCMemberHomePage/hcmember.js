...
//   const NMTypeMembers = filteredMembers.filter(member => member.type === "NM");
  ...
  return (
    ...
    <div className="member-list-container">
      ...
      <h3><br></br><b>Checkin/Checkout Members</b></h3>
            ...
            <div className="member-info">
              <div className="member-name">{member.firstName}, {member.lastName} <button className="member-btn">{member.type} </button><div className="member-actions">
                {(!status.get(member.emailAddress)) && 
                  <button className="checkin-btn" style={{backgroundColor: 'Red', float: 'right'}} onClick={() => handleCheckin(member)}>Check In</button>
                }
				{status.get(member.emailAddress) &&
                  <button className="checkout-btn" style={{backgroundColor: 'green', float: 'right'}} onClick={() => handleCheckout(member)}>Check Out</button>
                }
              </div></div>
    ...
    <div className="enrollment-container">
	  <div class="nm-member-list nm-type">
		<h3><b>Enroll Members/NonMembers</b></h3>
      ...
      <button className="enroll-btn" style={{backgroundColor: 'green', float: 'right'}}>Enroll</button>
    </Link></div>
