            ...
            <div className="membership">
                <div className="membership--container">
                    ...
                    <p className="membership--desc">
                        10% off on all classes register today{' '}
                    </p>
                    <div
                    ...
                    />*/}
                                ...
                                <h3 style={{ marginTop: '15px' }}>Basic</h3>
                            </div>

                            <div className="membership--perk">
                                <h3>
                                    <span>
                                        <sup>$</sup>10/<small>month</small>
                                    </span>
                                </h3>
                            </div>
                ...
                Join Now
                        ...
                        <div className="membership--card">
                            ...
                            <div className="membership--perk">
                                <h3>
                                    <span>
                                        <sup>$</sup>40/<small>month</small>
                                    </span>
                                </h3>
                            </div>
                            <div className="membership--perk--desc">
                                <ul>
                                    <li>- All Advanced plan Included</li>
                                    <li>- Unlimited Team Sessions</li>
                                    <li>- Monthly Monitoring</li>
                                    <li>
                                        - Personalized Nutritionist with meal plans
                                    </li>
                                </ul>
                            </div>
                            {/* <div className="button--su">
